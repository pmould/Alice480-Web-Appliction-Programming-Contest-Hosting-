      ...
      <div class="jumbotron">
        ...
        <div class="row">
          <div class="col-lg-12">
              ...
              <h1 id="tables">Rubric Creation</h1></br>
			 
				<?php
					echo '<h3>Rubric for Problem Number '.($_SESSION[ProbCount]+1).':</h3>';
				?>
			 </br>
          
            <div class="bs-example table-responsive"> 
<!---------------------------------------------------------------->
<form name="contest_form_ContR" class="contest_form" action="ContestCPInsert3.php" method="post">
	<div class="ContestForm" >
		<h4>
			
			How Many Criteria? <select class="contest_select name" name="noOfCrit" onchange="BuildFormFields(parseInt(this.value, 10));" ><br>
