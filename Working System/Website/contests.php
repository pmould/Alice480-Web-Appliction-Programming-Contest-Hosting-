      ...
      <div class="jumbotron">
        ...
        <div class="row">
          <div class="col-lg-12">
              ...
              <h1 id="tables">Contest Management</h1>
			...
			<?php  
				...
				if ($_SESSION['Perm_Create_Contest'] == 1 )
				{
					echo '<a id="mybutton2" href="ContestInit.php" title="link to ContestInit.php">';
					 echo '<button class="btn btn-lg btn-primary btn-block btn-warning"  name=\'DEL\'>Create a Contest</button><br />';
				}
				
				
				if ($_SESSION['Perm_Update_Contest'] == 1 )
				{
					echo '<a id="mybutton2" href="contests.php" title="link to contests.php">';
					 echo '<button class="btn btn-lg btn-primary btn-block btn-warning"  name=\'DEL\'>Update a Contest</button><br />';
				}
				
				if ($_SESSION['Perm_Delete_Contest'] == 1 )
				{
					echo '<a id="mybutton2" href="contests.php" title="link to contests.php">';
					 echo '<button class="btn btn-lg btn-primary btn-block btn-warning"  name=\'DEL\'>Delete a Contest</button><br />';
				}
				
				if ($_SESSION['Perm_Approve_Contest'] == 1 )
				{
					echo '<a id="mybutton2" href="contests.php" title="link to contests.php">';
					 echo '<button class="btn btn-lg btn-primary btn-block btn-warning"  name=\'DEL\'>Approve a Contest</button><br />';
				}
